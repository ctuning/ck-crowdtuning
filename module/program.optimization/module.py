...
def links(i):
    ...
    h+='[ <b>Android apps to crowd-tune workloads on mobile devices</b><a href="https://play.google.com/store/apps/details?id=openscience.crowdsource.experiments">Small apps</a>, <a href="https://play.google.com/store/apps/details?id=openscience.crowdsource.video.experiments">DNN (Caffe, etc)</a> ], \n'
